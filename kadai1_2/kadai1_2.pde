...
void draw(){
  for(int y=0;y<10;y++){
    for(int x=0;x<10;x++){
      ...
      fill(320-((x+y)*0.9),70,100-(x+y)*5.5);
      ...
      rect(1520+(-1)*(80*x),1520+(-1)*(80*y),80,80);
        ...
        for(int i=50;i>1;i--){
          fill(320-((x+y)*0.9),70,100-(x+y)*i*sin((x+y)*10*PI/i));
    ...
    for(int y=0;y<21;y++){
      for(int x=0;x<21;x++){
        ...
        ellipse(80*x,80*y,(x+y)/2,(x+y)/2);
        ellipse(1520+(-1)*x*80,y*80,(x+y)/2,(x+y)/2);
        ellipse(x*80,1520+(-1)*y*80,(x+y)/2,(x+y)/2);
        ellipse(1520+(-1)*x*80,1520+(-1)*y*80,(x+y)/2,(x+y)/2);
